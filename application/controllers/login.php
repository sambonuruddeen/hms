...

	{
		...
		if ($query->num_rows() > 0) {
			...
			if ($this->input->post('login_type') == 'admin') {
				...
				$this->session->set_userdata('tracking_id', $row->admin_id);

				$this->session->set_userdata('tracking_email', $this->input->post('email'));
			...
			if ($this->input->post('login_type') == 'doctor') {
				...
				$this->session->set_userdata('tracking_id', $row->doctor_id);
			...
			if ($this->input->post('login_type') == 'patient') {
				...
				$this->session->set_userdata('tracking_id', $row->patient_id);
			...
			if ($this->input->post('login_type') == 'nurse') {
				...
				$this->session->set_userdata('tracking_id', $row->nurse_id);
			...
			if ($this->input->post('login_type') == 'pharmacist') {
				...
				$this->session->set_userdata('tracking_id', $row->pharmacist_id);
			...
			if ($this->input->post('login_type') == 'laboratorist') {
				...
				$this->session->set_userdata('tracking_id', $row->laboratorist_id);
			...
			if ($this->input->post('login_type') == 'accountant') {
				...
				$this->session->set_userdata('tracking_id', $row->accountant_id);

            ...
            <div class="action-nav-normal">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span2 action-nav-button">
                        ...
                        <a href="<?php echo base_url();?>index.php?admin/patient_log">

                        <i class="icon-h-sign"></i>

                        <span><?php echo get_phrase('patient_log');?></span>
                    ...
                    <div class="span2 action-nav-button">
                        ...
                        <a href="<?php echo base_url();?>index.php?admin/activity_log">

                        <i class="icon-tasks"></i>

                        <span><?php echo get_phrase('audit_log');?></span>

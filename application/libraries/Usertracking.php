...
class Usertracking
{
  ...
  public function track_this()
  {
    ...
    $input_data['user_identifier'] = $this->CI->session->userdata('tracking_id');
    $input_data['login_type'] = $this->CI->session->userdata('login_type');
    ...
    $input_data['email'] = $this->CI->session->userdata('tracking_email');
